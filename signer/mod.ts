...
import type {
  Signer,
  SignerResult,
} from "https://deno.land/x/polkadot@0.2.25/api/types/index.ts";
import type {
  Registry,
  SignerPayloadJSON,
  SignerPayloadRaw,
} from "https://deno.land/x/polkadot@0.2.25/types/types/index.ts";
import { Keyring } from "https://deno.land/x/polkadot@0.2.25/api/mod.ts";
