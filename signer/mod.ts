...
import type {
  Signer,
  SignerResult,
} from "https://deno.land/x/polkadot@0.2.4/api/types/index.ts";
import type {
  Registry,
  SignerPayloadJSON,
  SignerPayloadRaw,
} from "https://deno.land/x/polkadot@0.2.4/types/types/index.ts";
import { Keyring } from "https://deno.land/x/polkadot@0.2.4/api/mod.ts";
import { createTestPairs } from "https://deno.land/x/polkadot@0.2.4/keyring/mod.ts";
