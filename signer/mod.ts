import {
  ApiPromise,
  WsProvider,
} from "https://deno.land/x/polkadot@0.2.35/api/mod.ts";
import type {
  Signer,
  SignerResult,
} from "https://deno.land/x/polkadot@0.2.35/api/types/index.ts";
import type {
  Registry,
  SignerPayloadJSON,
  SignerPayloadRaw,
} from "https://deno.land/x/polkadot@0.2.35/types/types/index.ts";
import { Keyring } from "https://deno.land/x/polkadot@0.2.35/api/mod.ts";
import { createTestPairs } from "https://deno.land/x/polkadot@0.2.35/keyring/mod.ts";
