import "https://deno.land/x/polkadot@0.2.19/api-augment/mod.ts";
import {
  ApiPromise,
  WsProvider,
} from "https://deno.land/x/polkadot@0.2.19/api/mod.ts";
import { Client } from "https://deno.land/x/subshell@0.2.19-1/client/mod.ts";
// import { VerboseSigner } from "https://deno.land/x/subshell@0.2.19-1/signer/mod.ts";
