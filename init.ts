import "https://deno.land/x/polkadot@0.0.4-9/api-augment/mod.ts";
import {
  ApiPromise,
  WsProvider,
} from "https://deno.land/x/polkadot@0.0.4-9/api/mod.ts";
import { Client } from "https://deno.land/x/subshell@0.0.4-3/client/mod.ts";
// import { VerboseSigner } from "https://deno.land/x/subshell@0.0.4-3/signer/mod.ts";
