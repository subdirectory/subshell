...
import { Client } from "https://deno.land/x/subshell@0.2.43-6/client/mod.ts";
// import { VerboseSigner } from "https://deno.land/x/subshell@0.2.43-6/signer/mod.ts";
...
export async function showBanner() {
  ...
  let GearShellBannerImage = new Uint8Array(
    await (await fetch(GearShellBannerImage)).arrayBuffer(),
  );
