import "https://deno.land/x/polkadot@0.2.37/api-augment/mod.ts";
import {
  ApiPromise,
  WsProvider,
} from "https://deno.land/x/polkadot@0.2.37/api/mod.ts";
import { Client } from "https://deno.land/x/subshell@0.2.37/client/mod.ts";
// import { VerboseSigner } from "https://deno.land/x/subshell@0.2.37/signer/mod.ts";
